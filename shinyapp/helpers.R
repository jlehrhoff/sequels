###################################################
## Create daily gropuings for "Franchise Fights" ##
###################################################

setwd('Desktop/jlehrhoff_github/movies/shinyapp')
temp <- read.csv('data/movies.csv')
...
####################################################
## Create totals gropuings for "Franchise Fights" ##
####################################################

grossrating <- read.csv('data/grossrating.csv')
...
#####################################
## Replace CSVs with final version ##
#####################################
